...
If the user points to a `functional-specs/` directory:
1. Read `README.md` to get the module map
2. Read `system/03-user-roles-and-personas.md` for current roles
3. Read `reference/business-rules-master.md` for current rules
4. Read affected module files: `01-user-stories.md`, `02-screen-descriptions.md`, `03-business-rules.md`, `04-data-requirements.md`, `05-error-handling.md`
