...
Ask for the path to the `functional-specs/` directory. If the user pastes spec content directly into the conversation, that works too.
...
### Generate `/mnt/user-data/outputs/spec-updates/00-impact-analysis.md`:
...
### New Files Needed
- `modules/[new-module]/` — [If a new module is needed, list all 6 files]
